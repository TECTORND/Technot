...
async def bo_ll(event):
    ...
    if cmd in (
        ...
        return await event.reply(
            "Sorry, This Is Sensitive Data I Cant Send It To Public.& Reported to Admin Of [Technot](https://t.me/Technot_Updates) Group admin. & Dont Try To Send Any Information Without Knowing Anything."
        )
