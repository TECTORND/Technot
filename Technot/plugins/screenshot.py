...
@techno.techno_cmd(
    ...
    info={
        ...
        "usage": "{tr}ss <link>",
        "examples": "{tr}ss https://github.com/TeamTechnot/Technot",
    },
)
async def _(event):
    ...
    try:
        ...
        inputstr = input_str
        if cmd == "ss":
            technourl = url(inputstr)
            if not technourl:
                inputstr = "http://" + input_str
                technourl = url(inputstr)
            if not technourl:
                return await technoevent.edit("`The given input is not supported url`")
        if cmd == "gis":
            inputstr = f"https://www.google.com/search?q={input_str}"
        driver.get(inputstr)
        await technoevent.edit("`Calculating Page Dimensions`")
        ...
        await technoevent.edit("`Stoppping Chrome Bin`")
        driver.close()
        ...
        await technoevent.edit(f"`{traceback.format_exc()}`")
...
@techno.techno_cmd(
    ...
    info={
        ...
        "examples": "{tr}scapture https://github.com/TeamTechnot/Technot",
    },
)
async def _(event):
    "To Take a screenshot of a website."
    ...
    if "image" in contentType:
        with io.BytesIO(response_api.content) as screenshot_image:
            ...
            try:
                ...
                await technoevent.edit(str(e))
    else:
        await technoevent.edit(f"`{response_api.text}`")
