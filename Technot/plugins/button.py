...
# button post makker for TechnoUserBot thanks to uniborg for the base

# by @TECHNOBOY_02 (@echnobot_Support)
import os
import re
...
@techno.techno_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [TechnoUserBot]<buttonurl:https://t.me/Technot_Support17:same> [support]<buttonurl:https://t.me/Technot_Updates>",
    },
)
async def _(event):
...
@techno.techno_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test <media:downloads/thumb_image.jpg> [google]<buttonurl:https://www.google.com> [Technot]<buttonurl:https://t.me/Technot_Updates:same> [support]<buttonurl:https://t.me/Technot_op>",
    },
)
async def _(event):
