...
@techno.techno_cmd(
    ...
    info={
        "header": "check how long it takes to ping your Technot",
...
async def ping(event):
    ...
    if type == " -a":
        ...
        await technoevent.edit(f"**👨‍💻 Average Pong!**\n➥ {ms} ms")
    else:
        technoevent = await eor(event, "<b><i>🔥 Ping! 🔥</b></i>", "html")
