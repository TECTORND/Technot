...
async def anim(event):
    ...
    animation_chars = [
        ...
        "😡",
        "😢",
        "‎**Repo of TechnoUserBot**",
        "😁",
        "😧",
        "😡",
        "😢",
        "__**[Good to see you guys....]**__(github.com/TeamTechnot/Technot)",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
