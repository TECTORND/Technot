...
async def sticklet(event):
    ...
    fontsize = 230
    FONT_FILE = await get_font_file(event.client, "@Techno_Fonts", font_file_name)
    ...
    image_stream.name = "TechnoUserBot.webp"
...
@techno.techno_cmd(
    ...
    info={
        ...
        "examples": "{tr}googl Technouserbot",
    },
)
async def twt(event):
