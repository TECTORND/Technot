...
@techno.techno_cmd(
    ...
    info={
        "header": "To create a private group/channel with Technot.",
        ...
        "examples": "{tr}create b TechnoUserBot",
    },
)
async def _(event):
    "To create a private group/channel with Technot"
    type_of_group = event.pattern_match.group(1)
    group_name = event.pattern_match.group(2)
    if type_of_group == "c":
        descript = "This is a Test Channel created using TechnoUserBot"
    else:
        descript = "This is a Test Group created using TechnoUserBot"
    if type_of_group == "g":
        try:
