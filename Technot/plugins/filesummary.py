# file summary plugin for TechnoUserBot  by @TECHNO_K_BOY
import time
...
@techno.techno_cmd(
    ...
    info={
        ...
        "examples": "{tr}chatfs @Technot_Updates",
    },
)
async def _(event):  # sourcery no-metrics
    ...
    await technoevent.edit(result, parse_mode="HTML", link_preview=False)
