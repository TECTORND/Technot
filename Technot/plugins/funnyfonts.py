...
@techno.techno_cmd(
    ...
    info={
        ...
        "examples": "{tr}weeb TechnoUserBot",
    },
)
...
@techno.techno_cmd(
    ...
    info={
        ...
        "examples": "{tr}downside TechnoUserBot",
    },
)
...
@techno.techno_cmd(
    ...
    info={
        ...
        "examples": "{tr}subscript TechnoUserBot",
    },
)
async def stylish_generator(event):
...
@techno.techno_cmd(
    ...
    info={
        ...
        "examples": "{tr}superscript TechnoUserBot",
    },
)
async def stylish_generator(event):
