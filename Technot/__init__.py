...
__author__ = "TeamTechnot <https://github.com/TeamTechnot/Technot>"
__copyright__ = f"Technot Copyright (C) 2022 - 2023  { __author__}"
...
if Config.PRIVATE_GROUP_BOT_API_ID == 0:
    if getgvar("PRIVATE_GROUP_BOT_API_ID") is None:
        Config.BOTLOG = False
        Config.BOTLOG_CHATID = "me"
    else:
        Config.BOTLOG_CHATID = int(getgvar("PRIVATE_GROUP_BOT_API_ID"))
        Config.PRIVATE_GROUP_BOT_API_ID = int(getgvar("PRIVATE_GROUP_BOT_API_ID"))
        Config.BOTLOG = True
else:
...
if Config.PM_LOGGER_GROUP_ID == 0:
    if getgvar("PM_LOGGER_GROUP_ID") is None:
        Config.PM_LOGGER_GROUP_ID = -100
    else:
        Config.PM_LOGGER_GROUP_ID = int(getgvar("PM_LOGGER_GROUP_ID"))
